...
Original file is located at
    https://colab.research.google.com/drive/1pRLssBTOeUnYkHyQZX_FxwQhNHwFZ7Hd
...
def print_hi():
    ...
    surname = input("may the lord bless you, whtas your surname")
    print(f'Hi,my name is {name}, {surname}, {age}')  # Press Ctrl+F8 to toggle the breakpoint.
...
# Define variable
    number = int(input("Enter a number: "))
    number1 = int(input("Enter a divisor for first number"))
    # Check if the number is even or odd
    if number % number1 == 0:
        result = "divisible"
    else:
